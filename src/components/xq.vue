    ...
    <div id="home">
        ...
        <section>
            <div class="center">
                ...
                <div class="right">
                    <div class="connect" v-for="(v,index1) in list" :key="index1">
                        <div class="top">
                            <p :id='"fa"+index1'>{{v.name}}</p>
                            <div class="top1">
                                <p>大家喜欢吃，才叫真好吃</p>
                                <van-icon name="ellipsis" class="tb"/>
                            </div>
                        </div>
                        <div class="nei" v-for="(item,index2) in v.foods" :key="index2">
                            <div class="img">
                            ...
                            <div class="wenzi">
                                ...
                                <div class="price">
                                    ...
                                    <div class="jiajian">
                                        ...
                                        <span @click="add($event,index1,index2)">
                                            +
                                        </span>
                                    </div>
                                </div>
...
export default {
  ...
  methods:{
      add($event,index1,index2){
          console.log($event)
          var top = event.clientY,
              left = event.clientX,
              endTop = window.innerHeight-30,
              endLeft = 20;
              console.log(top,left,endTop,endLeft)
          ...
          var inner = outer.find('.point-inner')
            ...
            setTimeout(function() {
                outer[0].style.webkitTransForm = 'translate3d(0,'+(endTop-top)+'rem,0)'
                inner[0].style.webkitTransForm = 'translate3d('+(endLeft-left)+'rem,0,0)'
                setTimeout(function() {
